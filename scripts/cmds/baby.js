    ...
    if (event.type !== "message_reply" && mahmud.some(word => message.startsWith(word))) {
      ...
      const res = await axios.post(`${await baseApiUrl()}/api/hinata`, { text, style: 3, attachments });  return res.data.message; } catch {  return "error janu🥹";
       ...
       const randomMessage = [
          ...
          "কিক খাবা নাকি 🥵✊",
          "বেশি ডাকলে গালি দিব কিন্তু 😃😒",
          "naw amr boss k message daw m.me/onik",
          "লুচ্চামি করশ কেন 😁😎",
          ...
          "অ্যাসলামওয়ালিকুম",
          "কেমন আসো",
          "●───༊༆ 😩༎ ༎পত্রিকায় ༎ দেখলাম༎🥶 ༎এই গ্রুপে আমি ༎ নাকি༎ একমাত্র ༎༎ single ছেলে 😼😼😁🤪 ●───༊༆🥴_😌",
          "বলেন ম্যাডাম__😌",
          ...
          "😾—মন বিক্রি করে দিমু-🤨😒টাকার দরকার-Mb কিনতে হবে কেউ কিনবেন🙈-🙂 —বাকি চেয়ে কেউ লজ্জা দিবেন না-🤭🫣 🤨🙂😁🥱 🖤🦋দিন শেষে সূর্যটাও বুঝিয়ে দেয়, সময় শেষ হলে স্থাঁন পরিবর্তন হয়..!!🥰",
          ...
          "ღ─༆─༄𝑰 𝑳𝒐𝒗𝒆 𝒀𝒐𝒖 🌹🌸─ ༊ থা্ঁমে্ঁন্ঁ আ্ঁবা্ঁর্ঁ প্ঁরে্ঁন্ঁ 🙆‍♂️🐸─ ༊ 𝐓𝐡𝐚𝐧𝐤𝐬 2 বা্ঁর্ঁ 𝐏𝐫𝐨𝐩𝐨𝐬𝐞 ক্ঁরা্ঁর্ঁ জ্ঁন্য্ঁ 😜👅ღ─༊─༆",
